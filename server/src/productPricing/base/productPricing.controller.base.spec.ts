...
describe("ProductPricing", () => {
  ...
  test("POST /productPricings", async () => {
  ...
  test("GET /productPricings", async () => {
    await request(app.getHttpServer())
      .get("/productPricings")
  ...
  test("GET /productPricings/:id non existing", async () => {
    await request(app.getHttpServer())
      .get(`${"/productPricings"}/${nonExistingId}`)
  ...
  test("GET /productPricings/:id existing", async () => {
    await request(app.getHttpServer())
      .get(`${"/productPricings"}/${existingId}`)
      .expect(HttpStatus.OK)
      .expect({
        ...FIND_ONE_RESULT,
