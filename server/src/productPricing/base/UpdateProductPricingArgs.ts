...
@ArgsType()
class UpdateProductPricingArgs {
  @Field(() => ProductPricingWhereUniqueInput, { nullable: false })
  where!: ProductPricingWhereUniqueInput;
  @Field(() => ProductPricingUpdateInput, { nullable: false })
  data!: ProductPricingUpdateInput;
}

export { UpdateProductPricingArgs };
